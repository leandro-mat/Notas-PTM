...
Na sequência provamos um lema que será utilizado 
na prova da Lei Zero-Um de Kolmogorov. 
...
Sejam $(\Omega,\F,\P)$ um espaço de probabilidade. 
Se $\{X_n\}$ é uma sequência de v.a.'s independentes
com $\sigma$-álgebra caudal $\mathcal{T}$, então 
para todo evento $E\in\mathcal{T}$ temos que 
$\P(E)=0$ ou $1$. Portanto a $\sigma$-álgebra 
$\mathcal{T}$ é quase-trivial.
\end{teorema}
