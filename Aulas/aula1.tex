...
\begin{enumerate}
\item[$\blacklozenge$] $AB\equiv A \cap B$.
\item[$\blacklozenge$] $A \setminus B \equiv A \cap B^c$.
...
\begin{exercicio}[Associatividade] Mostre que para quaisquer subconjuntos $A,B$ e $C$ 
...
\begin{exercicio}[Leis de de Morgan] Sejam $I$ um conjunto arbitrário de índices
...
\begin{exercicio}[Distributiva] Sejam $I$ um conjunto arbitrário de índices, 
