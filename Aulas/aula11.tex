...
pela topologia $\tau$. Nesta seção vamos estar
bastante interessados no caso em que $\Omega=\mathbb{R}^n$
...
$\mu(E)-\mu(E_1\cup E_2\cup\ldots\cup E_N)<\varepsilon$.
...
de conjuntos e a $\sigma$-aditividade de $\mu$ temos que 
\[
\mu\left(\bigcup_{m=1}^N A_m - \bigcup_{m=1}^n K_m \right)
\leq
