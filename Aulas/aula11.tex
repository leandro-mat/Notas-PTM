...
\section[Teorema de Kolmogorov para Produtos Cartesianos Não-Enumeráveis]
...
\begin{teorema}[Teorema da Existência de Kolmogorov]
...
$\mathcal{C}_1\cup \mathcal{C}_2 \in \mathcal{F}_{I\cup J}$ 
e portanto é também um conjunto cilíndrico.
\end{proof}